...
public class UserServiceTest {
  ...
  public void getAllTest() {
      ...
      output.add(new User("Tom", "Jones", "tjones1", "12345", "123st"));
  ...
  public void getByIdTest() {
      Optional<User> OptionalOutput = Optional.of(new User(1L, "Tom", "Jones", "tjones1", "12345", "123st"));
      User output = new User(1L, "Tom", "Jones", "tjones1", "12345", "123st");
  ...
  public void createTest() {
      User input = new User("Tom", "Jones", "tjones1", "12345", "123st");
      User output = new User(1L, "Tom", "Jones", "tjones1", "12345", "123st");
  ...
  public void updateTest() {
      User input = new User("Tom", "Jones", "tjones1", "12345", "123st");
      Optional<User> existing = Optional.of(new User(1L, "Jim", "Jones", "jjones1", "12345", "123st"));
      User output = new User(1L, "Tom", "Jones", "tjones1", "12345", "123st");
